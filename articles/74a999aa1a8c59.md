...
AWS_COGNITO_URL 以外は `src/aws-exports.js` にある値を記述します。

```:.env.development.local
AWS_REGION="ap-northeast-1"
AWS_COGNITO_USER_POOLS_ID="ap-northeast-1_XXXXXXXX"
AWS_COGNITO_USER_POOLS_WEB_CLIENT_ID="1rjnt22ltlaXXXXXXXXXXXXX"
AWS_COGNITO_URL="https://XXXXXXXXXX.auth.ap-northeast-1.amazoncognito.com"
```

AWS_COGNITO_URL は Cognito の Console で Cognito ドメインを作成して値を設定します。
...
```
CognitoIdentityServiceProvider.{AWS_COGNITO_USER_POOLS_WEB_CLIENT_ID}.XXXX-XXXX-XXXX-XXXX-XXXXXXXXX.idToken
```
...
ここで環境変数 AWS_COGNITO_URL で設定した Cognito ドメインを使用します。
